/* paranoia.c
   ...
   The classic "paranoia" floating point test!
 
   Build this with:
     clang --config pic32cz8110ca80208.cfg -lm -o paranoia.elf paranoia.c  &&  
     llvm-size -B paranoia.elf  &&  
     llvm-objcopy -O ihex paranoia.elf paranoia.hex
 */
...
// We'll use an LED on the board as an activity indicator for the serial port.
...
static void send_serial_byte(char c)
{
// 19200 baud
